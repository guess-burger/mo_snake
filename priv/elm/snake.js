...
Elm.Main.make = function (_elm) {
   ...
   var _op = {};
   var render_point = F2(function (colour,point) {
      var size = 25;
      var xStart = size * -6;
      var yStart = size * 6;
      return A2($Graphics$Collage.move,
      {ctor: "_Tuple2",_0: $Basics.toFloat(xStart + size * point.x),_1: $Basics.toFloat(yStart - size * point.y)},
      A2($Graphics$Collage.filled,colour,$Graphics$Collage.square(size)));
   });
   var to_colour = function (colour) {
      var _p0 = colour;
      switch (_p0)
   ...
   var render_snake = function (snake) {
      var colour = to_colour(snake.colour);
      var render_coloured_point = render_point(colour);
      return A2($List.map,render_coloured_point,snake.points);
   };
   var render = F2(function (_p1,state) {
      var _p2 = _p1;
      ...
      A2($Graphics$Element.color,$Color.white,A3($Graphics$Collage.collage,300,300,A2($List.concatMap,render_snake,state.snakes)))));
   });
   var directionSignal = function () {
      var arrowsToDelta = function (_p3) {
         var _p4 = _p3;
         var _p5 = {ctor: "_Tuple2",_0: _p4.x,_1: _p4.y};
         _v3_5: do {
            _v3_4: do {
               _v3_3: do {
                  switch (_p5._0)
                  {case 0: switch (_p5._1)
                       {case 0: return $Maybe.Nothing;
                          ...
                          case -1: break _v3_4;
                          default: break _v3_5;}
                     case -1: return $Maybe.Just("Left");
                     case 1: return $Maybe.Just("Right");
                     default: switch (_p5._1)
                       {case 1: break _v3_3;
                          case -1: break _v3_4;
                          default: break _v3_5;}}
               } while (false);
      ...
      return A3($Signal.filterMap,arrowsToDelta,"Right",$Keyboard.wasd);
   }();
   var directions = Elm.Native.Port.make(_elm).outboundSignal("directions",function (v) {    return v;},directionSignal);
   var server_state = Elm.Native.Port.make(_elm).inboundSignal("server_state",
   "Main.State",
   function (v) {
      return typeof v === "object" && "snakes" in v ? {_: {}
                                                      ,snakes: typeof v.snakes === "object" && v.snakes instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.snakes.map(function (v) {
                                                         return typeof v === "object" && "points" in v && "id" in v && "colour" in v ? {_: {}
                                                                                                                                       ,points: typeof v.points === "object" && v.points instanceof Array ? Elm.Native.List.make(_elm).fromArray(v.points.map(function (v) {
                                                                                                                                       ...
                                                                                                                                       v.id)
                                                                                                                                       ,colour: typeof v.colour === "string" || typeof v.colour === "object" && v.colour instanceof String ? v.colour : _U.badPort("a string",
                                                                                                                                       v.colour)} : _U.badPort("an object with fields `points`, `id`, `colour`",
                                                         v);
                                                      })) : _U.badPort("an array",v.snakes)} : _U.badPort("an object with fields `snakes`",v);
   });
   var main = A3($Signal.map2,render,$Window.dimensions,server_state);
   var Down = {ctor: "Down"};
   var Up = {ctor: "Up"};
   var Right = {ctor: "Right"};
   var Left = {ctor: "Left"};
   var State = function (a) {    return {snakes: a};};
   var Snake = F3(function (a,b,c) {    return {points: a,id: b,colour: c};});
